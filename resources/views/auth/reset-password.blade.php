...
<head>
    ...
    <title>Reset Password - {{ config('app.name', 'Toko Kunci Barokah') }}</title>
...
<body class="font-sans antialiased bg-gradient-to-br from-blue-50 via-white to-blue-100">
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 to-blue-800 relative overflow-hidden">
            ...
            <!-- Decorative Elements -->
            <div class="absolute top-10 left-10 w-32 h-32 bg-white opacity-10 rounded-full blur-2xl"></div>
            ...
            <div class="relative z-10 flex flex-col justify-center items-center w-full p-12 text-white">
                ...
                <h1 class="text-4xl font-bold mb-4 text-center">Toko Kunci Barokah</h1>
                <p class="text-xl text-center text-blue-100 mb-8 max-w-md">Solusi Terpercaya untuk Semua Kebutuhan Kunci Anda</p>
                ...
                <div class="space-y-4 mt-8">
                    <div class="flex items-center space-x-3">
                        ...
                        <span class="text-blue-100">Layanan Profesional & Cepat</span>
                    </div>
                    <div class="flex items-center space-x-3">
                        <svg class="w-6 h-6 text-green-300" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                        </svg>
                        <span class="text-blue-100">Harga Terjangkau & Transparan</span>
                    </div>
                    <div class="flex items-center space-x-3">
                        <svg class="w-6 h-6 text-green-300" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                        </svg>
                        <span class="text-blue-100">Teknisi Berpengalaman</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8">
            <div class="w-full max-w-md">
                ...
                <div class="lg:hidden text-center mb-8">
                    ...
                    <h2 class="text-2xl font-bold text-gray-900">Toko Kunci Barokah</h2>
                </div>
                    ...
                    <div>
                        ...
                        <div class="relative" x-data="{ showPasswordConfirm: false }">
                            ...
                            <button type="button" @click="showPasswordConfirm = !showPasswordConfirm"
                                class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-gray-700">
                                <svg x-show="!showPasswordConfirm" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M10 12a2 2 0 100-4 2 2 0 000 4z"/>
                                    <path fill-rule="evenodd" d="M.458 10C1.732 5.943 5.522 3 10 3s8.268 2.943 9.542 7c-1.274 4.057-5.064 7-9.542 7S1.732 14.057.458 10zM14 10a4 4 0 11-8 0 4 4 0 018 0z" clip-rule="evenodd"/>
                                </svg>
                                <svg x-show="showPasswordConfirm" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" style="display: none;">
                                    <path fill-rule="evenodd" d="M3.707 2.293a1 1 0 00-1.414 1.414l14 14a1 1 0 001.414-1.414l-1.473-1.473A10.014 10.014 0 0019.542 10C18.268 5.943 14.478 3 10 3a9.958 9.958 0 00-4.512 1.074l-1.78-1.781zm4.261 4.26l1.514 1.515a2.003 2.003 0 012.45 2.45l1.514 1.514a4 4 0 00-5.478-5.478z" clip-rule="evenodd"/>
                                    <path d="M12.454 16.697L9.75 13.992a4 4 0 01-3.742-3.741L2.335 6.578A9.98 9.98 0 00.458 10c1.274 4.057 5.065 7 9.542 7 .847 0 1.669-.105 2.454-.303z"/>
                                </svg>
                            </button>
                ...
                <div class="text-center">
                    <p class="text-gray-600">
                        ...
                        <a href="{{ route('login') }}" class="text-blue-600 hover:text-blue-800 font-semibold hover:underline inline-flex items-center">
                            <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="mt-8 p-4 bg-blue-50 rounded-lg text-center">
                    ...
                    <a href="https://wa.me/6285708770638" target="_blank" class="inline-flex items-center text-green-600 hover:text-green-700 font-medium text-sm">
