...
<head>
    ...
    <title>Register - {{ config('app.name', 'Toko Kunci Barokah') }}</title>
    ...
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 to-blue-800 relative overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col justify-center items-center w-full p-12 text-white">
                ...
                <h1 class="text-4xl font-bold mb-4 text-center">Bergabung dengan Kami</h1>
                <p class="text-xl text-center text-blue-100 mb-8 max-w-md">Daftar sekarang dan nikmati kemudahan layanan kunci profesional</p>
                
                <!-- Benefits -->
                <div class="space-y-6 mt-8 max-w-md">
                    <div class="flex items-start space-x-4 bg-white bg-opacity-10 rounded-lg p-4 backdrop-blur-sm">
                        <svg class="w-8 h-8 text-green-300 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                        </svg>
                        <div>
                            <h3 class="font-semibold mb-1">Pemesanan Mudah</h3>
                            <p class="text-sm text-blue-100">Pesan layanan kunci langsung dari aplikasi</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-4 bg-white bg-opacity-10 rounded-lg p-4 backdrop-blur-sm">
                        ...
                        <div>
                            <h3 class="font-semibold mb-1">Tracking Order</h3>
                            <p class="text-sm text-blue-100">Pantau status pesanan Anda real-time</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-4 bg-white bg-opacity-10 rounded-lg p-4 backdrop-blur-sm">
                        ...
                        <div>
                            <h3 class="font-semibold mb-1">Promo Eksklusif</h3>
                            <p class="text-sm text-blue-100">Dapatkan penawaran khusus member</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8">
            <div class="w-full max-w-md">
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-5">
                    ...
                    <!-- Phone (Optional - tambahkan di migration users jika ingin) -->
                    <div>
